...
public class ConfidenceTest {
    ...
    void testConfidence() throws Exception {
        ...
        System.arraycopy(messageIv            , 0, messageIvAndCipherText, 0               , messageIv.length            );
        System.arraycopy(encryptedMessageBytes, 0, messageIvAndCipherText, messageIv.length, encryptedMessageBytes.length);
